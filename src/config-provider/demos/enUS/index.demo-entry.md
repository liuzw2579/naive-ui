...
| preflight-style-disabled | `boolean` | `false` | Whether to disabled preflight style of ithinkdt-ui. If you disable it, you can take control of all global css. Also you can use `n-global-style` to apply global style (which is recommend since global style will be reactive). | 2.29.0 |
