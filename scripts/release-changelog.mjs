...
async function releaseChangelogToDingTalk() {
  ...
  const text = `${changelog.trim()}\n\n完整信息见 https://github.com/liuzw2579/ithinkdt-ui/blob/ithinkdt/CHANGELOG.zh-CN.md\n`
...
async function releaseChangelogToDiscord() {
  ...
  const message = `Changelog ${changelog.trim()}\n\nSee https://github.com/liuzw2579/ithinkdt-ui/blob/ithinkdt/CHANGELOG.en-US.md for details.\n`
